...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, position, screenSize):
        ...
        self.states = {
            ...
            5:(0, 62.33, 64, 62.33), 1:(64, 62.33, 64, 62.33), 2:(128, 62.33, 64, 62.33), 3:(192, 62.33, 64, 62.33), 4:(256, 62.33, 64, 62.33),
            10:(0, 124.66, 64, 62.33), 1:(64, 124.66, 64, 62.33), 2:(128, 124.66, 64, 62.33), 3:(192, 124.66, 64, 62.33), 4:(256, 124.66, 64, 62.33),
        }
        self.frame = 0
        self.cont = 0
        self.secs = 1
